...
DEPD = np.random.choice([0, 1], n_samples)  # Depression: 0 = No, 1 = Yes
...
# Delta versions of cognitive scores - 0 or 1 for no change/change
MEMORY_delta = np.random.choice([0, 1], n_samples, p=[0.7, 0.3])
ORIENT_delta = np.random.choice([0, 1], n_samples, p=[0.7, 0.3])
COGMODE_delta = np.random.choice([0, 1], n_samples, p=[0.7, 0.3])

# Depression delta
DEPD_delta = np.random.choice([0, 1], n_samples, p=[0.7, 0.3])
